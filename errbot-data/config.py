...
BOT_DATA_DIR = r'/opt/data'
BOT_EXTRA_PLUGIN_DIR = r'/opt/plugins'

BOT_LOG_FILE = r'/opt/errbot.log'
BOT_LOG_LEVEL = logging.DEBUG

BOT_ADMINS = ('@CHANGE_ME', )  # !! Don't leave that to "@CHANGE_ME" if you connect your errbot to a chat system !!


# Copied from https://github.com/rroemhild/docker-errbot/blob/master/config.py
# ##########################################################################
# #                                                                        #
